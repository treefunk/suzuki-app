...
//        ib_nav_twitter.setOnClickListener(this)
    ...
    override fun onClick(view: View?) {
        when (view) {
            ...
            ib_top_notification -> findNavController(R.id.nav_host_container).navigate(R.id.action_global_upcomingServiceEventsFragment2)
            ...
            ib_menu_spareparts -> Navigation.findNavController(this, R.id.nav_host_container).navigate(R.id.action_global_sparePartsFragment)
